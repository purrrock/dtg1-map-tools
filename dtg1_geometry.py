    ...
    def generate_polygon(
        ...
        shapes = {
            ...
            "tshirt": [
                ...
                (R - 1.0, R - 3.0),       # 4. Низ правого рукава
                (1.5, R - 2.0),           # 5. Правая подмышка
                (1.5, -R),                # 6. Правый нижний край
                (-1.5, -R),               # 7. Левый нижний край
                (-1.5, R - 2.0),          # 8. Левая подмышка
                (-R + 1.0, R - 3.0),      # 9. Низ левого рукава
            ...
            "hammer": [
                ...
                (3.0, R - 2.0),         # 3. Нижний правый край бойка
                (1.0, R - 2.0),         # 4. Внутренний правый угол
                (1.0, -R),              # 5. Правый низ рукоятки
                (-1.0, -R),             # 6. Левый низ рукоятки
                (-1.0, R - 2.0),        # 7. Внутренний левый угол
                (-R, R - 2.0),          # 8. Низ левого выступа (гвоздодер)
            ...
            "dollar": [
                ...
                (-1.0, 1.0),          # 7. Внутренний верхний вырез (вниз к средней перекладине)
                (2.0, 1.0),           # 8. Верхний правый край средней перекладины
                (2.0, -2.5),          # 9. Правый нижний край буквы S (линия опущена)
                (0.5, -2.5),          # 10. Внутренний правый угол перехода к нижнему штриху
                (0.5, -R),            # 11. Правый нижний край нижнего штриха
                (-0.5, -R),           # 12. Левый нижний край нижнего штриха
                (-0.5, -2.5),         # 13. Внутренний левый угол перехода от штриха к S
                (-2.0, -2.5),         # 14. Левый нижний край буквы S (линия опущена)
                (-2.0, -1.5),         # 15. Верхний левый край нижней перекладины
                (1.0, -1.5),          # 16. Внутренний нижний вырез (вдоль нижней перекладины вправо)
                (1.0, 0.0),           # 17. Внутренний нижний вырез (вверх к средней перекладине)
                (-2.0, 0.0),          # 18. Нижний левый край средней перекладины

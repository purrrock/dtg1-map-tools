...
➡️ **[Download the ready-made compiler (.EXE) for Windows](https://github.com/purrrock/dtg1-map-tools/releases/latest)** [![GitHub release](https://img.shields.io/github/v/release/purrrock/dtg1-map-tools?color=green)](https://github.com/purrrock/dtg1-map-tools/releases/latest)

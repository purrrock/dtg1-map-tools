...
➡️ **[Download Pre-Compiled Offline Maps (Ready to copy to watch)](https://github.com/purrrock/dtg1-map-tools/releases/tag/latest-maps)** [![GitHub release](https://img.shields.io/badge/Maps-latest--maps-blue)](https://github.com/purrrock/dtg1-map-tools/releases/tag/latest-maps)
➡️ **[Download the ready-made compiler (.EXE) for Windows](https://github.com/purrrock/dtg1-map-tools/releases/tag/v1.5.0)** [![GitHub release](https://img.shields.io/github/v/release/purrrock/dtg1-map-tools?color=green)](https://github.com/purrrock/dtg1-map-tools/releases/tag/v1.5.0)

...
def get_shapes_definitions():
    ...
    shapes["barrier"] = [
        (0.0, 3.5),            # Верхняя внутренняя впадина (пересечение лучей)
        (R - 3.5, R),          # Левая верхняя точка правого луча (скос)
        (R, R - 3.5),          # Правая верхняя точка правого луча
        (3.5, 0.0),            # Правая внутренняя впадина
        (R, -R + 3.5),         # Правая нижняя точка правого луча
        (R - 3.5, -R),         # Левая нижняя точка правого луча (скос)
        (0.0, -3.5),           # Нижняя внутренняя впадина
        (-R + 3.5, -R),        # Правая нижняя точка левого луча
        (-R, -R + 3.5),        # Левая нижняя точка левого луча
        (-3.5, 0.0),           # Левая внутренняя впадина
        (-R, R - 3.5),         # Левая верхняя точка левого луча
        (-R + 3.5, R),         # Правая верхняя точка левого луча (скос)
        (0.0, 3.5)             # Замыкание контура
    ]
    return shapes

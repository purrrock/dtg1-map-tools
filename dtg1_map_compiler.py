...
Архитектурные особенности движка платформы C175C1:
...
class HWConfig:
    """Аппаратные константы платформы C175C1"""
    YZL_HEADER_SIZE = 32
    NODE_SIZE = 28
...
class MapCompiler:
    ...
    def compile_mlp(cls, features: List[MapFeature], filepath: str) -> None:
        ...
        for feature in features:
            ...
            # Запись метаданных для дальнейшей линковки в IDX
            feature.v1 = abs_offset - 24
    ...
    def create_empty_layer(layer_prefix: str) -> None:
        ...
        # Оригинальные бинарные строки из дампа прошивки пустой области
